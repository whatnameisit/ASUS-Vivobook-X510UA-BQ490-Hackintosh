...
DefinitionBlock ("", "SSDT", 2, "what", "LowBat", 0x00000000)
{
    ...
    */
    ...
    Method (\_SB.PCI0.LPCB.EC0.BAT0._BST, 0, NotSerialized)  // _BST: Battery Status
    {
        ...
        If ((DerefOf (\_SB.PCI0.LPCB.EC0.BAT0.PBST [Zero]) & One)) // Check the content in the first (Zero) index of the return package of _BST is DWORD 1, or discharging. DWORD 1 & One should return One, meaning true, or discharging is true.
        {
        ...
        Return (\_SB.PCI0.LPCB.EC0.BAT0.PBST) // _BST returns PBST.
    }
}
