...
- Studying the ACPI specs and usages is more interesting than I thought. I have implemented a fix for the [issue](https://github.com/whatnameisit/Asus-Vivobook-X510UA-BQ490-Hackintosh/issues/9) where the laptop wakes on low / warning battery level with instructions from [Hibernate on Low Battery](https://applelife.ru/threads/hibernate-pri-razrjade-batarei.2874421/) in [this feature branch](https://github.com/whatnameisit/Asus-Vivobook-X510UA-BQ490-Hackintosh/tree/batterylow). It should work, but I have named the file `SSDT-Battery-test.aml` only because I have not tested it nor have plans on testing by draining the battery until 5 percent remaining. The next project would be [Battery Information Supplement](https://github.com/acidanthera/VirtualSMC/blob/master/Docs/Battery%20Information%20Supplement.md).
